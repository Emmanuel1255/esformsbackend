...
body {font-family: 'Lato', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:20px 20px 10px 20px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Hello Financial Controller</div>
...
<div style="font-family: inherit; text-align: inherit"><strong>Total: ${
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 40px; line-height:28px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 28px">This Request has been Approved by ${user['Line Manager Name']}. Do you want to approve?</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="#FFFFFF" data-distribution="1,1">
    <tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><tablce border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="c588d3be-b94e-451d-b994-c67321eff57f">
      <tbody>
        <tr>
