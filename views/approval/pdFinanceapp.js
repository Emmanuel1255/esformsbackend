module.exports = function (user, req) {
    ...
    return {
      to: ['osman.kamara@sl.easysolar.org'],
  ...
  body {font-family: 'Lato', sans-serif;}
    ...
    <![endif]-->
      ...
      <tbody>
        <tr>
          <td style="padding:20px 20px 10px 20px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Hello Finance</div>
  <div style="font-family: inherit; text-align: center"><br></div>
  <div style="font-family: inherit; text-align: center">The Per Diem Request from ${
    user['Full Name']
  } - ${user['Job Title']}, has been Approved by the Financial Controller</div><div></div></div></td>
        </tr>
      </tbody>
  ...
  <div style="font-family: inherit; text-align: inherit"><strong>Total: ${
      ...
      <tbody>
        <tr>
          <td style="padding:18px 30px 18px 40px; line-height:28px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 28px">This Request has been Approved by the Financial Controller you can now do payment.</span></div><div></div></div></td>
        </tr>
      </tbody>
    </table>
