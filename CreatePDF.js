...
module.exports = (user) => {
  ...
  pdf
    ...
    .toFile(`./${user['First Name']}-request.pdf`, (err, res) => {
...
body {font-family: 'Lato', sans-serif}
  ...
  <![endif]-->
    ...
    <tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0pxmargin:0pxborder-spacing:0"><table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed" data-muid="79178f70-3054-4e9f-9b29-edfe3988719e">
    <tbody>
      <tr>
...
<div style="font-family: inherit text-align: inherit"><strong>Total: ${
  req.body.TOTALCLAIM
    ...
    <tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0pxmargin:0pxborder-spacing:0"><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed" width="100%" data-muid="c588d3be-b94e-451d-b994-c67321eff57f">
      <tbody>
        <tr>
      ...
      <tbody>
        <tr>
          <td style="padding:0pxmargin:0pxborder-spacing:0"><table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed" width="100%" data-muid="c588d3be-b94e-451d-b994-c67321eff57f.1">
      <tbody>
        <tr>
          <td align="center" bgcolor="" class="outer-td" style="padding:0px 0px 0px 0px">
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center">
